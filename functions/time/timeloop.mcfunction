...
execute if score "§o§7Match" matchvars matches 0 run titleraw @a actionbar {"rawtext":[{"text":"§7"},{"score":{"name":"§o§7StundenZehner ","objective":"clock"}},{"score":{"name":"§o§7StundenEiner ","objective":"clock"}},{"text":":"},{"score":{"name":"§o§7MinutenZehner ","objective":"clock"}},{"score":{"name":"§o§7MinutenEiner ","objective":"clock"}}]}
