...
execute if block ~2 ~1 ~-1 lit_redstone_lamp run scoreboard players add @p[x=~2,y=~1,z=~-7, r=1] playermatch 1
execute if block ~2 ~1 ~-2 lit_redstone_lamp run scoreboard players add @p[x=~2,y=~1,z=~-7, r=1] playermatch 1
execute if block ~2 ~1 ~-3 lit_redstone_lamp run scoreboard players add @p[x=~2,y=~1,z=~-7, r=1] playermatch 1
execute if block ~2 ~1 ~-4 lit_redstone_lamp run scoreboard players add @p[x=~2,y=~1,z=~-7, r=1] playermatch 1
execute if block ~2 ~1 ~-5 lit_redstone_lamp run scoreboard players add @p[x=~2,y=~1,z=~-7, r=1] playermatch 1
execute if block ~2 ~1 ~-6 lit_redstone_lamp run scoreboard players add @p[x=~2,y=~1,z=~-7, r=1] playermatch 1
...
execute as @p[x=~2,y=~1,z=~-7, r=1] if block ~2 ~1 ~-4 lit_redstone_lamp run xp 1 @p[x=~2,y=~1,z=~-7, r=1]
execute as @p[x=~2,y=~1,z=~-7, r=1] if block ~2 ~1 ~-5 lit_redstone_lamp run xp 2 @p[x=~2,y=~1,z=~-7, r=1]
execute as @p[x=~2,y=~1,z=~-7, r=1] if block ~2 ~1 ~-6 lit_redstone_lamp run xp 3 @p[x=~2,y=~1,z=~-7, r=1]
execute as @p[x=~2,y=~1,z=~-7, r=1] if block ~2 ~1 ~-4 lit_redstone_lamp run playsound random.orb @p[x=~2,y=~1,z=~-7, r=1]
execute as @p[x=~2,y=~1,z=~-7, r=1] if block ~2 ~1 ~-5 lit_redstone_lamp run playsound random.orb @p[x=~2,y=~1,z=~-7, r=1]
execute as @p[x=~2,y=~1,z=~-7, r=1] if block ~2 ~1 ~-6 lit_redstone_lamp run playsound random.orb @p[x=~2,y=~1,z=~-7, r=1] 
# Sollte der Score höher sein als der bisher höchste, den Sieger neu zuordnen 
execute if score @p[x=~2,y=~1,z=~-7, r=1] playermatch > "§o§7Sieger" matchvars run scoreboard players operation "§o§7Sieger" matchvars = @p[x=~2,y=~1,z=~-7, r=1] playermatch 
