...
execute if block ~2 ~1 ~-1 lit_redstone_lamp run scoreboard players add @a[x=~2,y=~1,z=~-7, r=1] playermatch 1
execute if block ~2 ~1 ~-2 lit_redstone_lamp run scoreboard players add @a[x=~2,y=~1,z=~-7, r=1] playermatch 1
execute if block ~2 ~1 ~-3 lit_redstone_lamp run scoreboard players add @a[x=~2,y=~1,z=~-7, r=1] playermatch 1
execute if block ~2 ~1 ~-4 lit_redstone_lamp run scoreboard players add @a[x=~2,y=~1,z=~-7, r=1] playermatch 1
execute if block ~2 ~1 ~-5 lit_redstone_lamp run scoreboard players add @a[x=~2,y=~1,z=~-7, r=1] playermatch 1
execute if block ~2 ~1 ~-6 lit_redstone_lamp run scoreboard players add @a[x=~2,y=~1,z=~-7, r=1] playermatch 1
...
execute as @a[x=~2,y=~1,z=~-7, r=1] if block ~2 ~1 ~-4 lit_redstone_lamp run xp 1 @a[x=~2,y=~1,z=~-7, r=1]
execute as @a[x=~2,y=~1,z=~-7, r=1] if block ~2 ~1 ~-5 lit_redstone_lamp run xp 2 @a[x=~2,y=~1,z=~-7, r=1]
execute as @a[x=~2,y=~1,z=~-7, r=1] if block ~2 ~1 ~-6 lit_redstone_lamp run xp 3 @a[x=~2,y=~1,z=~-7, r=1]
execute as @a[x=~2,y=~1,z=~-7, r=1] if block ~2 ~1 ~-4 lit_redstone_lamp run playsound random.orb @a[x=~2,y=~1,z=~-7, r=1]
execute as @a[x=~2,y=~1,z=~-7, r=1] if block ~2 ~1 ~-5 lit_redstone_lamp run playsound random.orb @a[x=~2,y=~1,z=~-7, r=1]
execute as @a[x=~2,y=~1,z=~-7, r=1] if block ~2 ~1 ~-6 lit_redstone_lamp run playsound random.orb @a[x=~2,y=~1,z=~-7, r=1] 
# Sollte der Score höher sein als der bisher höchste, den Sieger neu zuordnen 
execute if score @a[x=~2,y=~1,z=~-7, r=1] playermatch > "§o§7Sieger" matchvars run scoreboard players operation "§o§7Sieger" matchvars = @a[x=~2,y=~1,z=~-7, r=1] playermatch 
